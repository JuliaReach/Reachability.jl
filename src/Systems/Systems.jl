...
struct DiscreteSystem <: System
    # system's matrix
    A::Union{AbstractMatrix{Float64}, SparseMatrixExp}
    ...
    DiscreteSystem(A::Union{AbstractMatrix{Float64}, SparseMatrixExp}, X0::LazySet, δ::Float64) = new(A, X0, δ, ConstantNonDeterministicInput(VoidSet(size(A, 1))))
    DiscreteSystem(A::Union{AbstractMatrix{Float64}, SparseMatrixExp}, X0::LazySet, δ::Float64, U::LazySet) = new(A, X0, δ, ConstantNonDeterministicInput(U))
    DiscreteSystem(A::Union{AbstractMatrix{Float64}, SparseMatrixExp}, X0::LazySet, δ::Float64, U::Array{<:LazySet, 1}) = new(A, X0, δ, TimeVaryingNonDeterministicInput(U))
    DiscreteSystem(A::Union{AbstractMatrix{Float64}, SparseMatrixExp}, X0::LazySet, δ::Float64, U::NonDeterministicInput) = new(A, X0, δ, U)
end
